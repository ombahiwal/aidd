...
url = 'https://www.slowfood.de/unterstuetzer/verbaende_vereine'
r = requests.get(url)
print(r)
...
export = []
data_list = []
with io.open("sf_germany_clubs.csv", "w", newline = "", encoding="utf-8") as f:
    writer = csv.writer(f)
    writer.writerow(["Club or Association", "Person(s)", "Phone", "Email", "Website", "Address", "SlowFoodLink"])
