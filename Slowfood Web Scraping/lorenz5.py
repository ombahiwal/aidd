...
url = 'https://www.slowfood.de/unterstuetzer/winzer'
r = requests.get(url)
print(r)
...
export = []
data_list = []
with io.open("sf_germany_winemaker.csv", "w", newline = "", encoding="utf-8") as f:
    writer = csv.writer(f)
    writer.writerow(["Winemaker", "Person(s)", "Phone", "Email", "Website", "Address", "SlowFoodLink"])
