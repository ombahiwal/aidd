...
url = 'https://www.slowfood.de/unterstuetzer/gastronomen_hotels'
r = requests.get(url)
print(r)
...
export = []
data_list = []
with io.open("sf_germany_hotels.csv", "w", newline = "", encoding="utf-8") as f:
    writer = csv.writer(f)
    writer.writerow(["Hotels", "Person(s)", "Phone", "Email", "Website", "Address", "SlowFoodLink"])
