...
url = 'https://www.slowfood.de/unterstuetzer/haendler'
r = requests.get(url)
print(r)
...
export = []
data_list = []
with io.open("sf_germany_dealers.csv", "w", newline = "", encoding="utf-8") as f:
    writer = csv.writer(f)
    writer.writerow(["Dealer", "Person(s)", "Phone", "Email", "Website", "Address", "SlowFoodLink"])
