...
url = 'https://www.slowfood.de/unterstuetzer/produzenten'
r = requests.get(url)
print(r)
...
export = []
data_list = []
with io.open("sf_germany_producers.csv", "w", newline = "", encoding="utf-8") as f:
    writer = csv.writer(f)
    writer.writerow(["Producer", "Person(s)", "Phone", "Email", "Website", "Address", "SlowFoodLink"])
